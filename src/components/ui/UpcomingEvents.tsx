...
export default function UpcomingEvents() {
  ...
  return (
    <div className="bg-emerald-50 py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-emerald-700 max-w-2xl mx-auto">
            Don't miss out on the action! Join us for our upcoming wrestling events in Melbourne, FL.
          </p>
        </div>

        <div className="grid md:grid-cols-2 gap-8 mb-12 max-w-5xl mx-auto">
          {upcomingEvents.map((event, idx) => (
            <div key={idx} className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col h-full max-w-[500px] mx-auto w-full">
      ...
      <AllEvents isOpen={isAllEventsOpen} onClose={() => setIsAllEventsOpen(false)} />
    </div>
  );
}
